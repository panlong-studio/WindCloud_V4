...
int main(){
    ...
    /* 第三步：先按默认路径初始化日志，保证配置加载阶段也能输出日志。 */
    ...
    while(1){
        ...
        /* epoll_wait 最长等待 1000ms，超时后也能推进时间轮。 */
